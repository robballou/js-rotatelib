...
/**
 * Criteria for including or excluding items from the list of items
 */
export class Criteria {
   ...
   */
	...
	constructor(config: Partial<CriteriaConfig> = {}) {
		...
		// this maps an "exclude" style criteria to it's correct class
   ...
   */
	...
	/**
   * Check if a string is a valid criterion name
   */
	...
	/**
   * Check if a string is a valid "normal" criterion name
   */
